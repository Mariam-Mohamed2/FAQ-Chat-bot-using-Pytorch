...
from Preprocessing import Bag_of_words, tokenization,remove_stop_words,stemming
...
while True:
    ...
    sentence = tokenization(s)
    print("stemming      ",[stemming(word) for word in sentence])
